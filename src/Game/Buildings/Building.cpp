...
void Game::Building::Update( float deltaTime )
{
	...
	Engine::LineSegment::RenderWorldPos(camera, target, chimneyBase, chimneyBase + float2{20.0f, 0.0f}, 0xff0000);
	// Bottom
	Engine::LineSegment::RenderWorldPos(camera, target, chimneyBase + float2{20.0f, 0.0f},
	                                    chimneyBase + float2{20.0f, -50.0f}, 0xff0000); // Right
	Engine::LineSegment::RenderWorldPos(camera, target, chimneyBase + float2{20.0f, -50.0f},
	                                    chimneyBase + float2{0.0f, -50.0f}, 0xff0000); // Top
	Engine::LineSegment::RenderWorldPos(camera, target, chimneyBase + float2{0.0f, -50.0f}, chimneyBase, 0xff0000);
	// Left
	...
	Engine::LineSegment::RenderWorldPos(camera, target, doorBase + float2{40.0f, 0.0f},
	                                    doorBase + float2{40.0f, -40.0f}, 0xffffff);
	Engine::LineSegment::RenderWorldPos(camera, target, doorBase + float2{40.0f, -40.0f},
	                                    doorBase + float2{0.0f, -40.0f}, 0xffffff);
	...
	for (int i = 0; i < 3; i++)
	{
		...
		Engine::LineSegment::RenderWorldPos(camera, target, windowBase + float2{20.0f, 0.0f},
		                                    windowBase + float2{20.0f, -20.0f}, 0xffff00);
		Engine::LineSegment::RenderWorldPos(camera, target, windowBase + float2{20.0f, -20.0f},
		                                    windowBase + float2{0.0f, -20.0f}, 0xffff00);
